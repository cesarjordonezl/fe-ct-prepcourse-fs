...
function conection(status) {
   ...
   // Tu código:
    ...
    // Poner en comentario varias lineas seguidas (control+k+c)
...
function fizzBuzz(num) {
   ...
   // se ubica en ese orden por que javascrip toma primero y si lo ve repetido no lo toma
...
function operadoresLogicos(num1, num2, num3) {
   ...
   if(num1 > num2 && num1 > num3 && num1 > 0) return "Numero 1 es mayor y positivo";
    ...
    if (num3 > num1 && num3> num2) {num3= num3+1
     return num3; }
